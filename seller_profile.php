                    ...
                    <div class="card-body">
                      <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
                            <div class="row gx-3 mb-3">
                              ...
                              <div class="col-md-6">
                                  <label class="small mb-1" for="shop_name">Shop Name</label>
                                  <input class="form-control" id="shop_name" type="text" placeholder="" value="<?php echo $row['shop_name']; ?>">
                              </div>
                            </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateUserProfile() {
        ...
        var shop_name = document.getElementById('shop_name').value.trim(); // Added shop_name
        ...
        formData.append('shop_name', shop_name); // Added shop_name
        ...
        xhr.open('POST', 'php/seller_update_profile.php', true);
